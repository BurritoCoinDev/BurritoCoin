...
class TestBurritoCoinCli(BurritoCoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getblockchaininfo RPC and `burritocoin-cli getblockchaininfo`")
        ...
        if self.is_wallet_compiled():
            self.log.info("Test -getinfo and burritocoin-cli getwalletinfo return expected wallet info")
            ...
            # Test burritocoin-cli -generate with -rpcwallet in multiwallet mode.
