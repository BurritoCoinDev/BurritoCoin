...
"""Verify that starting burritocoin with -h works as expected."""

from test_framework.test_framework import BurritoCoinTestFramework
from test_framework.util import assert_equal

class HelpTest(BurritoCoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start burritocoin with -h for help text")
        ...
        self.log.info("Start burritocoin with -version for version information")
        ...
        self.log.info("Start burritocoind with -fakearg to make sure it does not start")
