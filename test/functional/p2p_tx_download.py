...
class TxDownloadTest(BurritoCoinTestFramework):
    ...
    def test_inv_block(self):
        ...
        tx = self.nodes[0].createrawtransaction(
            ...
            outputs={ADDRESS_BCRT1_UNSPENDABLE: 10 - 0.00025},
        )
    ...
    def run_test(self):
        ...
        # Run each test against new burritocoind instances, as setting mocktimes has long-term effects on when
