...
class P2PPermissionsTests(BurritoCoinTestFramework):
    ...
    def replaceinconfig(self, nodeid, old, new):
        with open(self.nodes[nodeid].burritocoinconf, encoding="utf8") as f:
            newText = f.read().replace(old, new)
        with open(self.nodes[nodeid].burritocoinconf, 'w', encoding="utf8") as f:
            f.write(newText)
