...
class TestShell:
    """Wrapper Class for BurritoCoinTestFramework.

    The TestShell class extends the BurritoCoinTestFramework
    ...
    class __TestShell(BurritoCoinTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by BurritoCoinTestFramework child class.
            self.num_nodes = 1
