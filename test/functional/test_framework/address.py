...
"""Encode and decode BurritoCoin addresses.
...
ADDRESS_BCRT1_UNSPENDABLE = 'rbrto1qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqlekxv0'
ADDRESS_BCRT1_UNSPENDABLE_DESCRIPTOR = 'addr(rbrto1qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqlekxv0)#nvrtdkr8'
# Coins sent to this address can be spent with a witness stack of just OP_TRUE
ADDRESS_BCRT1_P2WSH_OP_TRUE = 'rbrto1qft5p2uhsdcdc3l2ua4ap5qqfg4pjaqlp250x7us7a8qqhrxrxfsq7xh80f'
...
def program_to_witness(version, program, main=False):
    ...
    return encode_segwit_address("brto" if main else "rbrto", version, program)
