...
class TxnMallTest(BurritoCoinTestFramework):
    ...
    def run_test(self):
        ...
        # First: use raw transaction API to send 1240 BRTO to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using coinbase outputs
        ...
        # Node0's balance should be starting balance, plus 10 BRTO for another
