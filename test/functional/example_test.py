...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the BurritoCoinTestFramework
    pass


class ExampleTest(BurritoCoinTestFramework):
    # Each functional test is a subclass of the BurritoCoinTestFramework class.
    ...
    def custom_method(self):
        ...
        BurritoCoinTestFramework class so other tests can use it."""
