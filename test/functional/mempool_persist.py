...
By default, burritocoind will dump mempool on shutdown and
...
class MempoolPersistTest(BurritoCoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent burritocoind from writing mempool.dat to disk. Verify that `savemempool` fails")
