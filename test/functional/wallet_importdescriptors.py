...
class ImportDescriptorsTest(BurritoCoinTestFramework):
    ...
    def run_test(self):
        ...
        addresses += ["rbrto1qrd3n235cj2czsfmsuvqqpr3lu6lg0ju7z2eyse", "rbrto1qfqeppuvj0ww98r6qghmdkj70tv8qpche9twqsd"] # wpkh subscripts corresponding to the above addresses
        ...
        addresses = [
            'rbrto1qtmp74ayg7p24uslctssvjm06q5phz4yr5w7ttx', # m/0'/0'/0
            'rbrto1q8vprchan07gzagd5e6v9wd7azyucksq252cewd', # m/0'/0'/1
            'rbrto1qtuqdtha7zmqgcrr26n2rqxztv5y8rafjnhel8k', # m/0'/0'/2
            'rbrto1qau64272ymawq26t90md6an0ps99qkrsex4aed9', # m/0'/0'/3
            'rbrto1qsg97266hrh6cpmutqen8s4s962aryy77qnf2s9', # m/0'/0'/4
        ]
        ...
        test_address(wpriv,
                     ...
                     solvable=True,
                     ismine=True)
        txid = w0.sendtoaddress(address, 9.99995540)
        w0.generatetoaddress(6, w0.getnewaddress())
        self.sync_blocks()
        tx = wpriv.createrawtransaction([{"txid": txid, "vout": 0}], {w0.getnewaddress(): 9.999})
        ...
        assert_equal(addr, 'rbrto1qdt0qy5p7dzhxzmegnn4ulzhard33s2809arjqgjndx87rv5vd0fqy8ggv6') # Derived at m/84'/0'/0'/0
        change_addr = wmulti_priv.getrawchangeaddress('bech32')
        assert_equal(change_addr, 'rbrto1qt9uhe3a9hnq7vajl7a094z4s3crm9ttf8zw3f5v9gr2nyd7e3lns22lv0y')
        ...
        assert_equal(addr, 'rbrto1qp8s25ckjl7gr6x2q3dx3tn2pytwp05upkjztk6ey857tt50r5aeqa93ntc') # Derived at m/84'/0'/0'/1
