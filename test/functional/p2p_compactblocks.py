...
# TestP2PConn: A peer we use to send messages to burritocoind, and store responses.
...
class CompactBlocksTest(BurritoCoinTestFramework):
    ...
    # This test actually causes burritocoind to (reasonably!) disconnect us, so do this last.
    ...
    # burritocoind's choice of nonce.
    ...
    # Test that burritocoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, test_node):
        ...
        # Note that it's possible for burritocoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, test_node):
        version = test_node.cmpct_version
        node = self.nodes[0]
        # burritocoind will not send blocktxn responses for blocks whose height is
