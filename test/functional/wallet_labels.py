...
class WalletLabelsTest(BurritoCoinTestFramework):
    ...
    def run_test(self):
        ...
        # each with 1 address with a balance of 50 BurritoCoins
        ...
        BECH32_VALID = {
            '✔️_VER15_PROG40': 'rbrto10qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqnwayrn',
            '✔️_VER16_PROG03': 'rbrto1sqqqqqqndrdv',
            '✔️_VER16_PROB02': 'rbrto1sqqqqu2apng',
        }
        BECH32_INVALID = {
        ...
        for l in BECH32_INVALID:
            ...
            assert_raises_rpc_error(
                -5,
                "Address is not valid" if self.options.descriptors else "Invalid BurritoCoin address or script",
