Contributing to BurritoCoin Core
============================

The BurritoCoin Core project operates an open contributor model where anyone is
welcome to contribute towards development in the form of peer review, testing
and patches. This document explains the practical process and guidelines for
contributing.

First, in terms of structure, there is no particular concept of "BurritoCoin Core
...
Before you start contributing, familiarize yourself with the BurritoCoin Core build
system and tests. Refer to the documentation in the repository on how to build
BurritoCoin Core and how to run the unit tests, functional tests, and fuzz tests.
...
Most communication about BurritoCoin Core development happens on IRC, in the
`#burritocoin-core-dev` channel on Freenode. The easiest way to participate on IRC is
with the web client, [webchat.freenode.net](https://webchat.freenode.net/). Chat
history logs can be found
on [http://www.erisian.com.au/burritocoin-core-dev/](http://www.erisian.com.au/burritocoin-core-dev/)
and [http://gnusha.org/burritocoin-core-dev/](http://gnusha.org/burritocoin-core-dev/).

Discussion about codebase improvements happens in GitHub issues and pull
requests.

The developer
[mailing list](https://groups.google.com/forum/#!forum/burritocoin-dev)
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to burritocoin-qt
...
fork of BurritoCoin Core copies the merge. Instead, make any username mentions in a
...
The following applies to code changes to the BurritoCoin Core project (and related
projects such as libsecp256k1), and is not to be confused with overall BurritoCoin
Network Protocol consensus changes.

Whether a pull request is merged into BurritoCoin Core rests with the project merge
...
Patches that change BurritoCoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the BurritoCoin consensus, it must have been
...
The project leader is the release manager for each BurritoCoin Core release.
