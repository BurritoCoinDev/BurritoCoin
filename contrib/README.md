...
A Linux bash script that will set up traffic control (tc) to limit the outgoing bandwidth for connections to the BurritoCoin network. This means one can have an always-on burritocoind instance running, and another local burritocoind/burritocoin-qt instance which connects to this node and receives blocks from it.
