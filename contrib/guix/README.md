# Bootstrappable BurritoCoin Core Builds

This directory contains the files necessary to perform bootstrappable BurritoCoin
Core builds.
...
- 24GB of free disk space on the partition that the BurritoCoin Core git repository
  resides in
...
For a BurritoCoin Core depends development environment, simply invoke
...
From the top of a clean BurritoCoin Core repository:
...
To use dongcarl's substitute server for BurritoCoin Core builds after having
