#!/usr/bin/env python3
# Copyright (c) 2014-2021 The BurritoCoin Core developers
...
def main():
    ...
    g = sys.stdout
    indir = sys.argv[1]
    g.write('#ifndef BURRITOCOIN_CHAINPARAMSSEEDS_H\n')
    g.write('#define BURRITOCOIN_CHAINPARAMSSEEDS_H\n')
    g.write('/**\n')
    g.write(' * List of fixed seed nodes for the burritocoin network\n')
    ...
    g.write('#endif // BURRITOCOIN_CHAINPARAMSSEEDS_H\n')
