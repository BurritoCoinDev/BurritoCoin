...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the burritocoin repository."
  exit 1
fi
...
# See https://github.com/BurritoCoinDev/BurritoCoin/issues/16064
...
echo 'When compiling burritocoind, run `./configure` in the following way:'
echo
