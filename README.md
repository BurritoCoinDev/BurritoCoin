...
BurritoCoin is an experimental digital currency that enables instant payments to
anyone, anywhere in the world. BurritoCoin uses peer-to-peer technology to operate
with no central authority: managing transactions and issuing money are carried
out collectively by the network. BurritoCoin Core is the name of open source
...
BurritoCoin Core is released under the terms of the MIT license. See [COPYING](COPYING) for more
...
We only accept translation fixes that are submitted through [BurritoCoin Core's Transifex page](https://explore.transifex.com/burritocoin/burritocoin/).
Translations are converted to BurritoCoin periodically.
