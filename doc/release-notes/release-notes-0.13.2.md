BurritoCoin Core version 0.13.2 is now available from:
  ...
  <https://burritocoin.org/bin/burritocoin-core-0.13.2/>
...
- #8908 `4a974b2` Update burritocoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow burritocoin-tx to create v2 transactions (btcdrak)
