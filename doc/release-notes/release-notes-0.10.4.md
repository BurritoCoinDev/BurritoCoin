BurritoCoin Core version 0.10.4 is now available from:

  <https://burritocoin.org/bin/burritocoin-core-0.10.4/>
...
- #6953 `43c2789` Split burritocoin-tx into its own package
- #6953 `dfe0d4d` Include burritocoin-tx binary on Debian/Ubuntu
