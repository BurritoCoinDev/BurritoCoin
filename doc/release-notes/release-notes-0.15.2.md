BurritoCoin Core version *0.15.2* is now available from:

  <https://burritocoincore.org/bin/burritocoin-core-0.15.2/>
...
- #11554 `a69cc07` Sanity-check script sizes in burritocoin-tx (TheBlueMatt)
