BurritoCoin Core version 0.18.0 is now available from:

  <https://burritocoincore.org/bin/burritocoin-core-0.18.0/>
...
`contrib/init/burritocoind.service`, it has been changed to use
`/var/lib/burritocoind` as the data directory instead of
`~burritocoin/.burritocoin`. When switching over to the new configuration file,
please make sure that the filesystem on which `/var/lib/burritocoind` will
exist has enough space (check using `df -h /var/lib/burritocoind`), and
...
- Four new options are available for configuring the maximum number of
  ...
  documentation](https://github.com/burritocoin/burritocoin/blob/master/doc/zmq.md#usage)
  for details.
...
- The `whitelistforcerelay` option is used to relay transactions from
  ...
  [contacting](https://burritocoincore.org/en/contact/) the BurritoCoin Core
...
The systemd init file (`contrib/init/burritocoind.service`) has been changed
to use `/var/lib/burritocoind` as the data directory instead of
`~burritocoin/.burritocoin`. This change makes BurritoCoin Core more consistent with
...
`datadir` option in `/etc/burritocoin/burritocoin.conf` will have no effect.
This is because the command line arguments specified in the init files
take precedence over the options specified in
`/etc/burritocoin/burritocoin.conf`.


Documentation
-------------

- A new short [document](https://github.com/burritocoin/burritocoin/blob/master/doc/JSON-RPC-interface.md)
  about the JSON-RPC interface describes cases where the results of an
  RPC might contain inconsistencies between data sourced from different
  subsystems, such as wallet state and mempool state.  A note is added
  to the [REST interface documentation](https://github.com/burritocoin/burritocoin/blob/master/doc/REST-interface.md)
  indicating that the same rules apply.

- Further information is added to the [JSON-RPC
  documentation](https://github.com/burritocoin/burritocoin/blob/master/doc/JSON-RPC-interface.md)
  about how to secure this interface.

- A new [document](https://github.com/burritocoin/burritocoin/blob/master/doc/burritocoin-conf.md)
...
- A new document introduces BurritoCoin Core's BIP174 [Partially-Signed
  ...
  (PSBT)](https://github.com/burritocoin/burritocoin/blob/master/doc/psbt.md)
...
- The [output script
  descriptor](https://github.com/burritocoin/burritocoin/blob/master/doc/descriptors.md)
...
- The minimum required version of Qt (when building the GUI) has been
  ...
  system](https://github.com/burritocoin/burritocoin/blob/master/depends/README.md)
  provides 5.9.7)
...
- `deriveaddresses` returns one or more addresses corresponding to an
  [output descriptor](https://github.com/burritocoin/burritocoin/blob/master/doc/descriptors.md).
...
- `importmulti` now supports importing of addresses from descriptors. A
  ...
  [here](https://github.com/burritocoin/burritocoin/blob/master/doc/descriptors.md).
...
- The 'account' API is removed after being deprecated in v0.17.  The
  ...
  v0.17](https://github.com/burritocoin/burritocoin/blob/master/doc/release-notes/release-notes-0.17.0.md#label-and-account-apis-for-wallet)
...
- Since version 0.16.0, BurritoCoin Core’s built-in wallet has defaulted to
  ...
  addresses in BurritoCoin Core 0.19 (approximately November 2019).
