BurritoCoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/burritocoin/files/BurritoCoin/burritocoin-0.5.4/
...
http://gitorious.org/burritocoin/burritocoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix BurritoCoin-Qt notifications under Growl 1.3.
Increase required age of BurritoCoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxBurritoCoin properly when installing BurritoCoin-Qt over it. (Windows)
