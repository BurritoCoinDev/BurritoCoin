BurritoCoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/burritocoin/files/BurritoCoin/burritocoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the BurritoCoin
...
New/changed settings (command-line or burritocoin.conf file)
--------------------------------------------------------
