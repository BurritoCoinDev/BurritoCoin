...
BurritoCoin Core version 0.19.1 is now available from:

  <https://burritocoincore.org/bin/burritocoin-core-0.19.1/>
...
From BurritoCoin Core 0.17.0 onwards, macOS versions earlier than 10.10 are no
longer supported, as BurritoCoin Core is now built using Qt 5.9.x which requires
macOS 10.10+. Additionally, BurritoCoin Core does not yet change appearance when
...
- #17488 fix "burritocoind already running" warnings on macOS (fanquake)
