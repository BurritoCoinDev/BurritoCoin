BurritoCoin Core version 0.9.2.1 is now available from:

  https://burritocoin.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 BRTO to 0.01 BRTO
...
- Fix "Start burritocoin on system login"
