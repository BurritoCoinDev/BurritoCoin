BurritoCoin Core version 0.9.4 is now available from:

  https://burritocoin.org/bin/0.9.4/
...
this update is incompatible with the BurritoCoin system and could lead to consensus
forks.

BurritoCoin Core released binaries from https://burritocoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~burritocoin/+archive/ubuntu/burritocoin
- A third-party or self-compiled BurritoCoin Core

upgrade to BurritoCoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
