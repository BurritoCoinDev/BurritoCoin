...
BurritoCoin Core version 0.21.0 is now available from:

  <https://burritocoincore.org/bin/burritocoin-core-0.21.0/>
...
using the Linux kernel, macOS 10.12+, and Windows 7 and newer.  BurritoCoin
Core should also work on most other Unix-like systems but is not as
frequently tested on them.  It is not recommended to use BurritoCoin Core on
unsupported systems.

From BurritoCoin Core 0.20.0 onwards, macOS versions earlier than 10.12 are no
longer supported. Additionally, BurritoCoin Core does not yet change appearance
...
- This release adds support for signets
  ([BIP325](https://github.com/burritocoin/bips/blob/master/bip-0325.mediawiki)) in
...
Bugs and missing functionality can be reported to the [issue tracker](https://github.com/burritocoin/burritocoin/issues).
...
Users who already have a BurritoCoin Core wallet can continue to use it as they did before without
any change in behavior. Newly created Legacy Wallets (which remains the default type of wallet) will
behave as they did in previous versions of BurritoCoin Core.
...
The change to using descriptors changes the default derivation paths used by BurritoCoin Core
...
- #19284 Add seed.burritocoin.wiz.biz to DNS seeds (wiz)
...
- #20198 Show name, format and if uses descriptors in burritocoin-wallet tool (jonasschnelli)
...
- #19133 rpc, cli, test: add burritocoin-cli -generate command (jonatack)
...
- #20055 Set HTTP Content-Type in burritocoin-cli (laanwj)
...
### Build system
- #18504 Drop burritocoin-tx and burritocoin-wallet dependencies on libevent (ryanofsky)
...
- #18297 Use pkg-config in BURRITOCOIN_QT_CONFIGURE for all hosts including Windows (hebasto)
...
- #18653 add coverage for burritocoin-cli -rpcwait (jonatack)
...
- #18739 Document how to fuzz BurritoCoin Core using Honggfuzz (practicalswift)
...
- #19061 Add link to Visual Studio build readme (maitreburritocoin)
...
- #18817 Document differences in burritocoind and burritocoin-qt locale handling (practicalswift)
...
[Transifex](https://www.transifex.com/burritocoin/burritocoin/).
