BurritoCoin Core version 0.16.3 is now available from:

  <https://burritocoincore.org/bin/burritocoin-core-0.16.3/>
...
been discovered in BurritoCoin Core versions 0.14.0 up to 0.16.2. It is recommended
...
### Miscellaneous
- #13655 `1cdbea7` burritocoinconsensus: invalid flags error should be set to `burritocoinconsensus_err` (afk11)
