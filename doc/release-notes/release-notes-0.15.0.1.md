BurritoCoin Core version *0.15.0.1* is now available from:

  <https://burritocoin.org/bin/burritocoin-core-0.15.0.1/>

and

  <https://burritocoincore.org/bin/burritocoin-core-0.15.0.1/>
