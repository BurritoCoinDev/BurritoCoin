...
By default, BurritoCoin Core allows up to 125 connections to different peers, 10 of
...
limits are tiny. Keep in mind that burritocoin's trustless model works best if you are
