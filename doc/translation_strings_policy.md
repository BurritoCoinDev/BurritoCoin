...
This document provides guidelines for internationalization of the BurritoCoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `burritocoin_en.ts` remains unchanged.
