BurritoCoin Core version *0.15.1* is now available from:
  ...
  <https://download.burritocoin.org/burritocoin-0.15.1/>
...
The minimum relay fee `-minrelayfee` has been lowered to 0.01 burritos per kB (0.00001 BRTO). This is to prepare for dropping the minimum transaction fee to 0.1 burritos per kB (0.0001 BRTO) in the next release.
