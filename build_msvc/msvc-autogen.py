...
libs = [
    'libburritocoin_cli',
    'libburritocoin_common',
    'libburritocoin_crypto',
    'libburritocoin_server',
    'libburritocoin_util',
    'libburritocoin_wallet_tool',
    'libburritocoin_wallet',
    'libburritocoin_zmq',
    'bench_burritocoin',
    'libtest_util',
]
...
def main():
    parser = argparse.ArgumentParser(description='BurritoCoin-core msbuild configuration initialiser.')
        ...
        with open(vcxproj_filename + '.in', 'r', encoding='utf-8') as vcxproj_in_file:
            with open(vcxproj_filename, 'w', encoding='utf-8') as vcxproj_file:
                vcxproj_file.write(vcxproj_in_file.read().replace(
                    '@SOURCE_FILES@\n', content))
    copyfile(os.path.join(SOURCE_DIR,'../build_msvc/burritocoin_config.h'), os.path.join(SOURCE_DIR, 'config/burritocoin-config.h'))
