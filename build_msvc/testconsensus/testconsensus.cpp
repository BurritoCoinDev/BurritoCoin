...
// burritocoin includes.
#include <..\src\script\burritocoinconsensus.h>
...
int main()
{
    std::cout << "burritocoinconsensus version: " << burritocoinconsensus_version() << std::endl;
    ...
    auto op0Result = burritocoinconsensus_verify_script_with_amount(pubKeyScript.data(), pubKeyScript.size(), amount, (const unsigned char*)&stream[0], stream.size(), 0, burritocoinconsensus_SCRIPT_FLAGS_VERIFY_ALL, &err);
