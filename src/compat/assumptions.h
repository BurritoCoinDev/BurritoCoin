...
#ifndef BURRITOCOIN_COMPAT_ASSUMPTIONS_H
#define BURRITOCOIN_COMPAT_ASSUMPTIONS_H
...
#if defined(NDEBUG)
# error "BurritoCoin cannot be compiled without assertions."
#endif
...
#endif // BURRITOCOIN_COMPAT_ASSUMPTIONS_H
