...
#ifndef BURRITOCOIN_TEST_SCRIPTNUM10_H
#define BURRITOCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from BurritoCoin Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // BURRITOCOIN_TEST_BIGNUM_H
