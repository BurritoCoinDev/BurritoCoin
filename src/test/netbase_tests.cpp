...
{
    BOOST_CHECK(TestSplitHost("www.burritocoincore.org", "www.burritocoincore.org", -1));
    BOOST_CHECK(TestSplitHost("[www.burritocoincore.org]", "www.burritocoincore.org", -1));
    BOOST_CHECK(TestSplitHost("www.burritocoincore.org:80", "www.burritocoincore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.burritocoincore.org]:80", "www.burritocoincore.org", 80));
