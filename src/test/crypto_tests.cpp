...
BOOST_AUTO_TEST_CASE(sha256_testvectors) {
    ...
    TestSHA256("As BurritoCoin relies on 80 byte header hashes, we want to have an example for that.",
               "7c250f9fe0bdcecdde8c223790bfa26ee911b63973ad730de0d31bfb772edd58");
...
{
    /* test chacha20poly1305@burritocoin AEAD */
