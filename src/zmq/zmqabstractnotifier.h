// Copyright (c) 2015-2018 The BurritoCoin Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef BURRITOCOIN_ZMQ_ZMQABSTRACTNOTIFIER_H
#define BURRITOCOIN_ZMQ_ZMQABSTRACTNOTIFIER_H
...
#endif // BURRITOCOIN_ZMQ_ZMQABSTRACTNOTIFIER_H
