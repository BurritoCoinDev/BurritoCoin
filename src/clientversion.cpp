 ...
 * for both burritocoind and burritocoin-qt, to make it harder for attackers to
 * target servers or GUI users specifically.
 */
const std::string CLIENT_NAME("BurritoCoinCore");
...
/**
 * Format the subversion field according to BIP 14 spec (https://github.com/burritocoin/bips/blob/master/bip-0014.mediawiki)
 */
