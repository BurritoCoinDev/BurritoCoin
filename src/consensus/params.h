...
#ifndef BURRITOCOIN_CONSENSUS_PARAMS_H
#define BURRITOCOIN_CONSENSUS_PARAMS_H
...
enum DeploymentPos
{
    ...
    DEPLOYMENT_MWEB, // Deployment of MWEB (BIPs 0002-0004)
...
struct Params {
    ...
    /**
     * If true, witness commitments contain a payload equal to a BurritoCoin Script solution
...
#endif // BURRITOCOIN_CONSENSUS_PARAMS_H
