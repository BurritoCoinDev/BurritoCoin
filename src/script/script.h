...
#ifndef BURRITOCOIN_SCRIPT_SCRIPT_H
#define BURRITOCOIN_SCRIPT_SCRIPT_H
...
public:
    ...
    /**
     * Pre-version-0.6, BurritoCoin always counted CHECKMULTISIGs
...
#endif // BURRITOCOIN_SCRIPT_SCRIPT_H
