...
static void SetupBurritoCoinTxArgs(ArgsManager &argsman)
{
...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " burritocoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  burritocoin-tx [options] <hex-tx> [commands]  Update hex-encoded burritocoin transaction\n" +
            "or:     burritocoin-tx [options] -create [commands]   Create hex-encoded burritocoin transaction\n" +
            "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded burritocoin transaction
