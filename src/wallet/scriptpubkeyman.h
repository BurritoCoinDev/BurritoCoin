...
#ifndef BURRITOCOIN_WALLET_SCRIPTPUBKEYMAN_H
#define BURRITOCOIN_WALLET_SCRIPTPUBKEYMAN_H
 ...
 * change.
 *
 * The BurritoCoin Core wallet was originally a collection of unrelated private
...
#endif // BURRITOCOIN_WALLET_SCRIPTPUBKEYMAN_H
