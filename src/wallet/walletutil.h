...
#ifndef BURRITOCOIN_WALLET_WALLETUTIL_H
#define BURRITOCOIN_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! burritocoin from opening the wallet, thinking it was newly created, and
...
#endif // BURRITOCOIN_WALLET_WALLETUTIL_H
