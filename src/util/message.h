...
#ifndef BURRITOCOIN_UTIL_MESSAGE_H
#define BURRITOCOIN_UTIL_MESSAGE_H
 ...
 * @param[in] address Signer's burritocoin address, it must refer to a public key.
...
#endif // BURRITOCOIN_UTIL_MESSAGE_H
