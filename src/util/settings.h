...
#ifndef BURRITOCOIN_UTIL_SETTINGS_H
#define BURRITOCOIN_UTIL_SETTINGS_H
...
//!       https://github.com/burritocoin/burritocoin/pull/15934/files#r337691812)
...
#endif // BURRITOCOIN_UTIL_SETTINGS_H
