...
#ifndef BURRITOCOIN_RPC_PROTOCOL_H
#define BURRITOCOIN_RPC_PROTOCOL_H
...
enum RPCErrorCode
{
    ...
    // RPC_INTERNAL_ERROR should only be used for genuine errors in burritocoind
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  //!< BurritoCoin is not connected
...
#endif // BURRITOCOIN_RPC_PROTOCOL_H
