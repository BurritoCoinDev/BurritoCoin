...
const std::string EXAMPLE_ADDRESS[2] = {"brto1q09vm5lfy0j5reeulh4x5752q25uqqvz34hufdl", "brto1q02ad21edsxd23d32dfgqqsz4vv4nmtfzuklhy3"};
...
{
    return "> burritocoin-cli " + methodname + " " + args + "\n";
}

std::string HelpExampleRpc(const std::string& methodname, const std::string& args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\": \"curltest\", "
        "\"method\": \"" + methodname + "\", \"params\": [" + args + "]}' -H 'content-type: text/plain;' http://127.0.0.1:9226/\n";
}
