...
#ifndef BURRITOCOIN_NET_H
#define BURRITOCOIN_NET_H
...
enum class ConnectionType {
     ...
     * Note that in the literature ("Eclipse Attacks on BurritoCoin’s Peer-to-Peer Network")
