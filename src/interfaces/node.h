...
#ifndef BURRITOCOIN_INTERFACES_NODE_H
#define BURRITOCOIN_INTERFACES_NODE_H
...
//! Top-level interface for a burritocoin node (burritocoind process).
class Node
{
public:
    virtual ~Node() {}
...
#endif // BURRITOCOIN_INTERFACES_NODE_H
