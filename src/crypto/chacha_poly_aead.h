...
#ifndef BURRITOCOIN_CRYPTO_CHACHA_POLY_AEAD_H
#define BURRITOCOIN_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@burritocoin.
 *
 ...
 *
 * The chacha20-poly1305@burritocoin combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@burritocoin cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@burritocoin are relatively fast in
...
#endif // BURRITOCOIN_CRYPTO_CHACHA_POLY_AEAD_H
