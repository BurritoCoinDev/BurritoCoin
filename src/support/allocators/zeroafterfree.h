...
#ifndef BURRITOCOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
#define BURRITOCOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
...
#endif // BURRITOCOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
