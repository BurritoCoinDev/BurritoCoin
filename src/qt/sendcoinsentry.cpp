    ...
    platformStyle(_platformStyle)
{
    ...
    // normal burritocoin address field
    GUIUtil::setupAddressWidget(ui->payTo, this);
    // just a label for displaying burritocoin address(es)
    ui->payTo_is->setFont(GUIUtil::fixedPitchFont());

    // Connect signals
    connect(ui->payAmount, &BurritoCoinAmountField::valueChanged, this, &SendCoinsEntry::payAmountChanged);
