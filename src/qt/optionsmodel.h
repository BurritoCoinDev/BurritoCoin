...
#ifndef BURRITOCOIN_QT_OPTIONSMODEL_H
#define BURRITOCOIN_QT_OPTIONSMODEL_H
...
/** Interface from Qt to configuration data structure for BurritoCoin client.
...
public:
    ...
    enum OptionID {
        ...
        ProxyIPTor,             // QString
        ProxyPortTor,           // int
        DisplayUnit,            // BurritoCoinUnits::Unit
...
#endif // BURRITOCOIN_QT_OPTIONSMODEL_H
