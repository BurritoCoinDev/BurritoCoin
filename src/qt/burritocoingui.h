...
#ifndef BURRITOCOIN_QT_BURRITOCOINGUI_H
#define BURRITOCOIN_QT_BURRITOCOINGUI_H
...
/**
  BurritoCoin GUI main class. This class represents the main window of the BurritoCoin UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class BurritoCoinGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit BurritoCoinGUI(interfaces::Node& node, const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = nullptr);
    ~BurritoCoinGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a burritocoin wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
...
#endif // BURRITOCOIN_QT_BURRITOCOINGUI_H
