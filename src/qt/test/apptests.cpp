...
//! Entry point for BurritoCoinApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &BurritoCoinApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for BurritoCoinGUI tests.
void AppTests::guiTests(BurritoCoinGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &BurritoCoinGUI::consoleShown, this, &AppTests::consoleTests);
