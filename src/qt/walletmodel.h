...
#ifndef BURRITOCOIN_QT_WALLETMODEL_H
#define BURRITOCOIN_QT_WALLETMODEL_H
...
/** Interface to BurritoCoin wallet from Qt view code. */
...
#endif // BURRITOCOIN_QT_WALLETMODEL_H
